...
class MockAccountRepository implements AccountRepository {
  ...
  @override
  Future<Uint8List> downloadStatement(DateTime startDate, DateTime endDate) async => throw UnimplementedError();

  @override
  Future<Map<String, dynamic>> getDashboardStats() async => throw UnimplementedError();
}
