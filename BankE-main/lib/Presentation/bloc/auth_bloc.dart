...
class AuthBloc extends Bloc<AuthEvent, AuthState> {
  ...
  Future<void> _onUploadAvatar(UploadAvatarEvent event, Emitter<AuthState> emit) async {
    if (usersService == null) return;
    emit(AvatarUploadLoading());
    try {
      final response = await usersService!.uploadAvatar(event.filePath);
      usersService!.apiClient.ensureSuccess(response);
