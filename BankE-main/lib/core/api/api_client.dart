...
class ApiClient {
  ...
  static const String baseUrl = String.fromEnvironment(
    'API_BASE_URL',
    defaultValue: 'http://10.29.39.62:5221/api',
  );
        ...
        if (e.response?.statusCode == 401) {
          ...
          try {
            ...
            if (refreshResponse.statusCode == 200) {
              ...
              final newAccess = responseData['token'] ?? responseData['accessToken'];
              ...
              if (newAccess != null && newRefresh != null) {
                ...
                for (final pending in _pendingRequests) {
                  ...
                  dio.fetch(pending.options).then(
                        ...
                        onError: (err) => pending.handler.reject(
                            err is DioException
                                ? err
                                : DioException(
  ...
  void ensureSuccess(Response response) {
    ...
    final message =
        _extractMessage(response.data, _defaultMessageForStatus(statusCode));
    throw ApiException(
      statusCode: statusCode,
      message: message,
