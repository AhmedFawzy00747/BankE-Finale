...
abstract class AccountDataSource {
  ...
  Future<void> updateCardControls(String cardId, bool online, bool atm, bool international);
  ...
  Future<Uint8List> downloadStatement(DateTime startDate, DateTime endDate);
  Future<Map<String, dynamic>> fetchHomeDashboardStats();
