...
namespace BankE.Infrastructure.Repositories
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public UnitOfWork(BankEDbContext context)
        {
            ...
            ScheduledTransfers = new ScheduledTransferRepository(context);
            Budgets = new BudgetRepository(context);
            SavingGoals = new SavingGoalRepository(context);
        }
        ...
        public IScheduledTransferRepository ScheduledTransfers { get; }
        public IBudgetRepository Budgets { get; }
        public ISavingGoalRepository SavingGoals { get; }
